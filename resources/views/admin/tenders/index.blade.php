                            ...
                            <tr class="hover:bg-red-50/20 transition-colors">
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex items-center justify-center space-x-2">
                                            ...
                                            <a href="{{ route('admin.tenders.match', $tender->id) }}" class="inline-flex items-center px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white font-black text-[10px] uppercase tracking-widest rounded shadow-sm animate-pulse">
                                                Review
                                            </a>
                                            <a href="{{ route('admin.tenders.show', $tender->id) }}" class="p-2 text-slate-500 hover:text-red-600 border border-slate-200 rounded hover:border-red-600 transition" title="View">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                            </a>
                                            <a href="{{ route('admin.tenders.edit', $tender->id) }}" class="p-2 text-slate-500 hover:text-red-600 border border-slate-200 rounded hover:border-red-600 transition" title="Edit">
